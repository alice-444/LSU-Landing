...
const FAQHero: React.FC = () => {
  return (
    <section className="relative overflow-hidden bg-linear-to-br from-[#C9A0DC] via-[#A66FD9] to-[#4A90E2]">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32 text-center">
        ...
        <h1 className="text-5xl sm:text-6xl lg:text-7xl text-white mb-6 leading-tight">
          <span className="inline-block bg-white text-[#C9A0DC] px-8 py-3 rounded-2xl transform rotate-1 shadow-2xl mt-4">
            Foire aux questions
          </span>
        </h1>
