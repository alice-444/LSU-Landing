...
const FAQHero: React.FC = () => {
  return (
    <section className="relative overflow-hidden bg-linear-to-br from-(--purple) via-(--purple-dark) to-(--primary-blue)">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32 text-center">
        <div className="inline-flex items-center gap-2 bg-white/30 backdrop-blur-sm px-6 py-3 rounded-full mb-6 shadow-xl transform hover:scale-105 transition-transform">
          ...
          <span className="text-white font-bold">Questions Fréquentes</span>
        </div>

        <h1 className="text-5xl sm:text-6xl lg:text-7xl text-white mb-6 leading-tight">
          <span className="inline-block bg-white text-(--purple) px-8 py-3 rounded-2xl transform rotate-1 shadow-2xl mt-4">
            Foire aux questions
          </span>
        </h1>

        <p className="text-2xl text-white/90 max-w-3xl mx-auto mb-8">
          Trouve les réponses aux questions les plus courantes sur notre
          plateforme
        </p>
      </div>
