  ...
  return (
    <section className="relative bg-linear-to-br from-purple-50 via-orange-50 to-blue-50 py-24 overflow-hidden">
      <div className="absolute inset-0 opacity-40">
        <div className="absolute top-20 left-10 w-96 h-96 bg-(--purple) rounded-full blur-3xl animate-pulse"></div>
        <div
          className="absolute bottom-10 right-20 w-80 h-80 bg-(--brand-orange) rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 w-72 h-72 bg-(--green) rounded-full blur-3xl animate-pulse"
        ...
        <div className="bg-white rounded-[32px] p-8 sm:p-12 lg:p-16 border-[5px] border-gray-900 shadow-[12px_12px_0_0_rgba(0,0,0,0.1)]">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div
                className="inline-flex items-center gap-2 bg-linear-to-r from-(--brand-orange) to-(--purple) text-white px-5 py-2.5 rounded-full border-3 border-gray-900 shadow-[0_6px_0_0_rgba(0,0,0,0.15)]"
                ...
                <h2 className="mb-4">
                  <span className="block text-gray-900 font-black">
                    ...
                    <span className="relative inline-block">
                      ...
                      <span className="absolute bottom-1 left-0 w-full h-3 bg-(--brand-orange) opacity-30 -rotate-1"></span>
                    </span>
                  </span>
                </h2>
            ...
            <div className="relative">
              ...
              <p className="text-xs sm:text-sm text-(--quaternary-blue) mt-3 sm:mt-4">
                ...
                <Link
                  href="/privacy"
                  className="text-(--primary-blue) underline hover:text-(--secondary-blue) transition-colors duration-300"
                >
