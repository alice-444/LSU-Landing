  ...
  return (
    <div className="py-12 sm:py-16 md:py-20 bg-gradient-to-r from-[#fffaf5] via-white to-[#fffaf5] relative">
      <div className="container mx-auto text-center px-4 sm:px-6 lg:px-8">
        ...
        <Link href="/product">
          <motion.button
            className="mt-8 sm:mt-10 md:mt-12 bg-gradient-to-r from-[var(--primary-blue)] to-[var(--secondary-blue)] text-white py-2.5 sm:py-3 px-6 sm:px-8 rounded-full shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105 text-base sm:text-lg"
